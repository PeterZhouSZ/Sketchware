...
namespace curvenetwork {
    struct Core {
		...
		double find_snap_nearest_point(SnapType snapType, Vertex* v_min, Vertex*& v_snap) ;
		double find_snap_nearest_point(Vertex* v_min, Vertex*& v_snap) ;
		double find_snap_nearest_point(SnapType snapType, Vertex* v_min, kt84::PointNormal & d_snap) ;
		double find_snap_nearest_point(Vertex* v_min, kt84::PointNormal & d_snap) ;
