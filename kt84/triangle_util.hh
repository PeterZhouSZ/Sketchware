...
namespace kt84 {
    namespace triangle_util {
        ...
        inline void triangulate(const Format_poly& in_poly, Format_poly& out_poly, Format_ele& out_ele, Format_edge& out_edge, const std::string& switches = "pzQ") {
            ...
            ::triangulate(const_cast<char*>(switches.c_str()), &in, &out, 0);
        ...
        inline void triangulate(const Format_node& in_node, Format_ele& out_ele, const std::string& switches = "zQ") {
        ...
        inline void triangulate(const Format_poly& in_poly, Format_poly& out_poly, Format_ele& out_ele, const std::string& switches = "zQ") {
            Format_edge out_edge;
            triangulate(in_poly, out_poly, out_ele, out_edge, switches);
        }
    }
